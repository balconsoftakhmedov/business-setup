		...
		!-->
			...
			<div class="wpcf7 js" id="wpcf7-f784-o1" lang="en-US" dir="ltr">
				...
				<form action="/#wpcf7-f784-o1" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
					...
					<!-- Start of the form -->
					<div class="max-w-[568px] stm-c-form rounded-measurements-radius-xxxl bg-background-surface-default border-border-action-normal border-[1px] border-solid box-border flex flex-col items-start justify-start py-[38px] px-[39px] gap-measurements-gap-24 min-w-[320px] w-full text-sm text-text-base-primary ">
						<div class="self-stretch flex flex-col items-start justify-start gap-measurements-gap-16 max-w-full">
									...
									<div class="self-stretch flex-1 shadow-[0px_1px_2px_rgba(20,_21,_26,_0.05)] flex flex-row items-start justify-start">
										<div class="self-stretch flex-1 rounded-measurements-radius-xl bg-background-surface-default border-border-action-normal border-[1px] border-solidflex flex-row items-center justify-start py-2 px-[11px]">
											<p><span class="wpcf7-form-control-wrap" data-name="your-name"><input size="40" maxlength="400"
																												  class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required cf7-no-focus-border w-full border-none outline-none bg-transparent flex-1 flex flex-row items-center justify-start py-0 px-1 box-border font-body-s-bold text-sm text-text-base-tertiary"
																												  aria-required="true" aria-invalid="false" placeholder="Enter your full name" value="" type="text" name="your-name"></span>
											</p>
										</div>
									</div>
								</div>
									...
									<div class="self-stretch flex-1 shadow-[0px_1px_2px_rgba(20,_21,_26,_0.05)] flex flex-row items-start justify-start">
										<div class="self-stretch flex-1 rounded-measurements-radius-xl bg-background-surface-default border-border-action-normal border-[1px] border-solid  flex flex-row items-center justify-start py-2 px-[11px]">
											<p><span class="wpcf7-form-control-wrap" data-name="your-email"><input size="40" maxlength="400"
																												   class="wpcf7-form-control wpcf7-email wpcf7-validates-as-required wpcf7-text wpcf7-validates-as-email w-full cf7-no-border cf7-no-outline bg-transparent flex-1 flex flex-row items-center justify-start py-0 px-1 box-border font-body-s-bold text-sm text-text-base-tertiary"
																												   aria-required="true" aria-invalid="false" placeholder="Type your email" value="" type="email" name="your-email"></span>
											</p>
										</div>
									</div>
								</div>
							...
							<div class="self-stretch flex flex-row items-start justify-start flex-wrap content-start py-0 pl-0 pr-1.5 gap-x-2.5 gap-y-4">
								...
								<div class="h-[72px] flex-1 flex flex-col items-start justify-start gap-measurements-gap-8 min-w-[236px]">
									...
									<div class="self-stretch flex-1 shadow-[0px_1px_2px_rgba(20,_21,_26,_0.05)] flex flex-row items-start justify-start">
										<div class="self-stretch flex-1 rounded-measurements-radius-xl bg-background-surface-default border-border-action-normal border-[1px] border-solid flex flex-row items-center justify-start py-2 px-[11px]">
											<p><span class="wpcf7-form-control-wrap" data-name="your-phone"><input size="40" maxlength="400"
																												   class="wpcf7-form-control wpcf7-tel wpcf7-validates-as-required wpcf7-text wpcf7-validates-as-tel w-full cf7-no-border cf7-no-outline bg-transparent flex flex-row items-center justify-start py-0 px-1 box-border text-sm text-text-base-tertiary"
																												   aria-required="true" aria-invalid="false" placeholder="Your phone number" value="" type="tel" name="your-phone"></span>
											</p>
										</div>
									</div>
								</div>
									...
									<div class="self-stretch flex-1 shadow-[0px_1px_2px_rgba(20,_21,_26,_0.05)] flex flex-row items-start justify-start">
										<div class="self-stretch flex-1 rounded-measurements-radius-xl bg-background-surface-default border-border-action-normal border-[1px] border-solid flex flex-row items-center justify-start py-2 px-[11px]">
											<p><span class="wpcf7-form-control-wrap" data-name="your-service"><select
															class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required w-full cf7-no-border cf7-no-outline bg-transparent flex-1 flex flex-row items-center justify-between py-0 px-1 box-border text-sm text-text-base-tertiary"
															aria-required="true" aria-invalid="false" name="your-service"><option value="Please select">Please select</option><option value="Business Setup Services">Business Setup Services</option><option
																value="Financial Services">Financial Services</option><option value="Complex Business Support">Complex Business Support</option></select></span>
											</p>
										</div>
									</div>
								</div>
							...
							<div class="self-stretch h-28 flex flex-col items-start justify-start gap-measurements-gap-8 min-w-[144px] max-w-full">
								...
								<div class="self-stretch flex-1 shadow-[0px_1px_2px_rgba(20,_21,_26,_0.05)] flex flex-row items-start justify-start max-w-full h-full">
									<div class="self-stretch flex-1 rounded-measurements-radius-xl bg-background-surface-default border-border-action-normal border-[1px] border-solid box-border  flex flex-row items-center justify-start py-2 px-[11px] max-w-full stm-p-no">
										<p><span class="wpcf7-form-control-wrap" data-name="your-message"><textarea cols="40" rows="10" maxlength="2000"
																													class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required w-full cf7-no-border cf7-no-outline bg-transparent flex-1 flex flex-row items-center justify-start py-0 px-1 box-border text-sm text-text-base-tertiary"
																													aria-required="true" aria-invalid="false" placeholder="Type your message" name="your-message"></textarea></span>
										</p>
									</div>
								</div>
							</div>
...
<footer class="self-stretch  flex flex-col items-center justify-start pt-20 px-0 pb-0
	...
	<img class="w-full h-full absolute !m-[0] top-[0px] right-[0px] bottom-[1px] left-[0px] max-w-full overflow-hidden max-h-full object-contain hidden z-[0]" alt=""
	...
	<div class="w-[1210px] flex flex-row items-start justify-start flex-wrap content-start py-0 px-5 box-border gap-[30px] max-w-full">
		<div class="flex-1 flex flex-col items-start justify-start relative gap-[22px] min-w-[277px] max-w-full text-sm-2 text-text-base-primary font-poppins">
			<div class="flex flex-row items-center justify-center py-0 px-[3px]">
				...
				<a href="https://business-setup.test/">
					<img class="h-[60px] w-[97.1px] relative" loading="lazy" alt="" style="width: 120px;height: 32px" src="https://business-setup.test/wp-content/uploads/2024/09/logo.png">
				</a>
			</div>
			<div class="self-stretch flex flex-row items-center justify-center py-0 pl-0 pr-[30px] gap-[30px] mq450:gap-[15px] mq450:flex-wrap">
				...
				<div class="flex-1 flex flex-col items-start justify-start gap-2.5 min-w-[101px]">
					...
					<b class="self-stretch relative leading-[22px] hover:text-general-1-primary hover:[text-decoration:underline]"><a href="https://business-setup.test/about/"> About</a></b>
					<b class="self-stretch relative leading-[22px] hover:text-general-1-primary hover:[text-decoration:underline]"><a href="https://business-setup.test/business-setup-services/"> Business Setup</a></b>
					<b class="self-stretch relative leading-[22px] hover:text-general-1-primary hover:[text-decoration:underline]"><a href="https://business-setup.test/financial-services/"> Our Services</a></b>
					<b class="self-stretch relative leading-[22px] hover:text-general-1-primary hover:[text-decoration:underline]"><a href="#"> Resources</a></b>
				</div>
				<div class="flex-1 flex flex-col items-start justify-start py-0 pl-0 pr-0.5 box-border gap-2.5 min-w-[180px]">

					<b class="self-stretch relative leading-[22px]   hover:text-general-1-primary hover:[text-decoration:underline]"><a href="https://business-setup.test/careers/"> Careers</a></b>
					<b class="self-stretch relative leading-[22px]   hover:text-general-1-primary hover:[text-decoration:underline]"><a href="https://business-setup.test/contact/"> Contact Us</a></b>
					<b class="self-stretch relative leading-[22px]   hover:text-general-1-primary hover:[text-decoration:underline]"><a href="https://business-setup.test/privacy-policy-2/"> Privacy Policy</a></b>
					<b class="self-stretch relative leading-[22px]   hover:text-general-1-primary hover:[text-decoration:underline]"><a href="https://business-setup.test/terms-conditions/"> Terms &amp; Conditions</a></b>
				</div>
		...
		<div class="flex-1 flex flex-col items-start justify-start gap-5 min-w-[277px] max-w-full">
			<div class="self-stretch overflow-hidden flex flex-col items-start justify-start gap-2.5">
				...
				<div class="text-sm tracking-[-0.1px] leading-[20px] font-medium text-text-base-secondary">
		...
		<div class="flex-1 flex flex-col items-start justify-start gap-[30px] min-w-[277px] max-w-full">
			...
			<b class="self-stretch h-[72px] relative leading-[24px] inline-block">
				<a class="hover:[text-decoration:underline]"
				   href="https://www.google.com/maps/search/Office+105,+Level+1,+Emaar+Square+%E2%80%93+Building+4,+Sheikh+Mohammed+Bin+Rashid+Boulevard+Downtown+Dubai,+United+Arab+Emirates/@25.0756584,54.8978306,103733m/data=!3m2!1e3!4b1?entry=ttu&amp;g_ep=EgoyMDI0MDkxNi4wIKXMDSoASAFQAw%3D%3D">
	...
	<div class="self-stretch flex flex-col items-center justify-start max-w-full">
			...
			<div class="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
				<div class="bg-general-1-primary ">
					<div class="sm:flex sm:items-start ">
						...
						<div class="wpcf7 js" id="wpcf7-f486-o2" lang="en-US" dir="ltr">
							<div class="screen-reader-response"><p role="status" aria-live="polite" aria-atomic="true"></p>
								<ul></ul>
							</div>
							<form action="/#wpcf7-f486-o2" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
								<div style="display: none;">
						...
						gap-5 max-w-full z-[1] mq450:pl-5 mq450:box-border mq850:pt-[39px] mq850:pb-[39px] mq850:box-border" style="padding-left:50px">
									<p><span class="wpcf7-form-control-wrap" data-name="your-name"><input size="40" maxlength="400"
																										  class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required w-80 cf7-no-border cf7-no-outline cf7-bg-white cf7-flex-row cf7-items-start cf7-justify-start cf7-py-15px cf7-pl-15px cf7-pr-15px cf7-box-border text-base cf7-text-gray cf7-whitespace-nowrap cf7-z-index-1 cf7-custom-input w-full"
																										  aria-required="true" aria-invalid="false" placeholder="Full name *" value="" type="text" name="your-name"></span>
									</p>
									<p><span class="wpcf7-form-control-wrap" data-name="your-email"><input size="40" maxlength="400"
																										   class="wpcf7-form-control wpcf7-email wpcf7-validates-as-required wpcf7-text wpcf7-validates-as-email w-80 cf7-no-border cf7-no-outline cf7-bg-white cf7-flex-row cf7-items-start cf7-justify-start cf7-py-15px cf7-pl-15px cf7-pr-15px cf7-box-border text-base cf7-text-gray cf7-whitespace-nowrap cf7-z-index-1 cf7-custom-input w-full"
																										   aria-required="true" aria-invalid="false" placeholder="Your E-mail *" value="" type="email" name="your-email"></span>
									</p>
									<div class="w-80 bg-general-white flex flex-row items-start justify-start  px-[11px]  pl-0 text-general-8-secondary cs-tel  w-full">
									...
									<div class="w-full">
										<p><span class="wpcf7-form-control-wrap" data-name="your-service"><select
														class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required w-80 cf7-bg-white flex flex-row items-start justify-between cf7-py-15px cf7-pl-15px cf7-pr-15px cf7-box-border cf7-gap-5 cf7-z-index-1 w-full" aria-required="true"
														aria-invalid="false" name="your-service"><option value="Select a service required">Select a service required</option><option value="Business Setup Services">Business Setup Services</option><option
															value="Financial Services">Financial Services</option><option value="Complex Business Support">Complex Business Support</option></select></span>
										</p>
									</div>
									<div class="w-full">
										<p><span class="wpcf7-form-control-wrap" data-name="your-message"><textarea cols="40" rows="10" maxlength="2000" class="wpcf7-form-control wpcf7-textarea self-stretch cf7-h-140px relative cf7-custom-input cf7-cs-pd-20 w-full" aria-invalid="false"
