...
<head>
	...
	<?php wp_head(); ?>
	<script type="text/javascript" src="/wp-content/themes/business-setup/assets/js/components/header/header.js?ver=1725194558" id="starter-header-js"></script>
</head>
<body <?php body_class(); ?>>
<div class="w-full">
...
<img
			...
			alt=""
			src="/wp-content/themes/business-setup/web/404/public/desert1654439-1920@2x.png"
	/>
<?php
wp_body_open();
...
<div class="w-full relative bg-general-white overflow-hidden flex flex-col items-start justify-start pt-[0px] px-[0px] pb-[249px] box-border gap-[17.5px] leading-[normal] tracking-[normal] text-right text-sm text-general-1-secondary-variant font-body-b3-merriweather-14">
      <img class="w-full h-full absolute !m-[0] top-[0px] right-[0px] bottom-[0px] left-[0px] max-w-full overflow-hidden max-h-full object-cover" alt="" src="/wp-content/themes/business-setup/web/404/public/desert1654439-1920@2x.png">
      ...
      <section class="self-stretch flex flex-col items-start justify-start max-w-full">
        ...
        <img class="self-stretch relative max-w-full overflow-hidden max-h-full z-[1] mt-[-40px]" alt="" src="/wp-content/themes/business-setup/web/404/public/mask-group.svg">
      </section>
      <div class="self-stretch bg-general-white hidden flex-col items-center justify-start max-w-full z-[2]">
        <div class="self-stretch flex flex-row items-center justify-between py-[25px] px-[375px] gap-[-109px] [row-gap:20px] mq1050:flex-wrap">
          <div class="hidden flex-row items-center justify-end gap-[7.5px] z-[1] text-smi mq1050:flex-wrap">
            <img class="h-[22px] w-[22px] relative overflow-hidden shrink-0 min-h-[22px]" alt="" src="/wp-content/themes/business-setup/web/404/public/feather-iconsglobe.svg">

            <div class="h-[22px] relative leading-[22px] inline-block">
              English
            </div>
            <img class="h-[22px] w-[22px] relative min-h-[22px]" alt="" src="/wp-content/themes/business-setup/web/404/public/iconssmall-iconsarrowchevrondown.svg">
          </div>
          <div class="h-[24px] flex flex-row items-center justify-end gap-[8px] z-[2] text-elements-neutral-2">
            <img class="h-[22px] w-[22px] relative overflow-hidden shrink-0" alt="" src="/wp-content/themes/business-setup/web/404/public/feather-iconsphone.svg">
          ...
          <div class="flex flex-row items-center justify-start gap-[2px] z-[3] mq1050:flex-wrap">
            <img class="h-[36px] w-[36px] relative" alt="" src="/wp-content/themes/business-setup/web/404/public/logomark.svg">

            <img class="h-[27.8px] w-[131px] relative" alt="" src="/wp-content/themes/business-setup/web/404/public/logotype.svg">
          </div>
          <div class="flex flex-row items-start justify-start gap-[30px] z-[4] mq1050:flex-wrap">
            <div class="h-[24px] flex flex-row items-center justify-start gap-[8px]">
              <img class="h-[22px] w-[22px] relative overflow-hidden shrink-0" alt="" src="/wp-content/themes/business-setup/web/404/public/feather-iconssearch.svg">

              <div class="self-stretch relative leading-[24px]">Search</div>
            </div>
            <div class="h-[24px] flex flex-row items-center justify-start gap-[8px]">
              <img class="h-[22px] w-[22px] relative overflow-hidden shrink-0" alt="" src="/wp-content/themes/business-setup/web/404/public/feather-iconsshoppingcart.svg">

              <div class="self-stretch relative leading-[24px]">Cart</div>
            </div>
          </div>
        </div>
        <img class="w-[1170px] relative max-h-full max-w-full" alt="" src="/wp-content/themes/business-setup/web/404/public/shape-4.svg">
        ...
        <div class="self-stretch flex flex-row items-center justify-center pt-[21px] px-[375px] pb-[20px] gap-[33px] text-base text-general-1-secondary font-button-dm-sans-16 mq1225:flex-wrap mq1225:justify-start">
          <div class="h-[22px] flex flex-row items-center justify-start gap-[4px] text-general-1-primary">
            ...
            <div class="flex flex-col items-start justify-start">
              <img class="w-[16px] h-[16px] relative" alt="" src="/wp-content/themes/business-setup/web/404/public/iconssmall-iconsarrowchevrondown-1.svg">
            </div>
          </div>
          <div class="h-[22px] flex flex-row items-center justify-start gap-[4px]">
            ...
            <div class="flex flex-col items-start justify-start">
              <img class="w-[16px] h-[16px] relative" alt="" src="/wp-content/themes/business-setup/web/404/public/iconssmall-iconsarrowchevrondown-2.svg">
            </div>
          </div>
          <div class="h-[22px] flex flex-row items-center justify-start gap-[4px]">
          ...
          <div class="h-[22px] hidden flex-row items-center justify-start gap-[4px] text-general-white">
            ...
            <div class="flex flex-col items-start justify-start">
              <img class="w-[16px] h-[16px] relative" alt="" src="/wp-content/themes/business-setup/web/404/public/iconssmall-iconsarrowchevrondown-4.svg">
            </div>
          </div>
          <div class="h-[22px] flex flex-row items-center justify-start gap-[4px]">
