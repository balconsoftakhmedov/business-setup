	...
	<div class="w-full">
		...
		<section
			...
			<div class="w-full flex flex-row items-start justify-start relative max-w-full ml-[10%] lg:ml-[0px]">
				...
				<div class="flex-1 flex flex-col items-center justify-start pt-0 pb-[110px] box-border gap-10 bg-[url('/wp-content/themes/business-setup/web/public/title2@3x.png')] bg-cover bg-no-repeat bg-[top] max-w-full z-[3] lg:pl-[140px] lg:pr-[140px] lg:pb-[71px] lg:box-border mq450:pl-5 mq450:pr-5 mq450:pb-[46px] mq450:box-border mq850:gap-10 mq850:box-border">
...
<b class="relative tracking-[-0.03em] leading-[66px] mq450:text-17xl mq450:leading-[40px] mq850:text-29xl mq850:leading-[53px]
		...
		<section
			...
			<div class="w-[1170px] grid flex-row items-start justify-start gap-[30px] max-w-full grid-cols-[repeat(4,_minmax(202px,_1fr))] z-[1] text-left text-smi text-general-white font-button-dm-sans-16 lg:justify-center lg:grid-cols-[repeat(2,_minmax(202px,_351px))] mq450:grid-cols-[minmax(202px,_1fr)]">
				<div class="h-[375px] overflow-hidden overflow-hidden flex flex-col items-start justify-end py-[25px] pl-[25px] pr-5 box-border gap-[5px] bg-[url('/wp-content/themes/business-setup/web/public/member-info@3x.png')] bg-cover bg-no-repeat bg-[top] transition-transform duration-300 ease-in-out hover:scale-105 hover:bg-opacity-75">
					...
					<div class="overflow-hidden flex flex-row items-center justify-start gap-2.5">
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px] transition-transform duration-300 ease-in-out hover:scale-110" loading="lazy" alt="" src="/wp-content/themes/business-setup/web/public/link--facebook.svg"></a>

						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px] transition-transform duration-300 ease-in-out hover:scale-110" loading="lazy" alt="" src="/wp-content/themes/business-setup/web/public/link--twitter.svg"></a>

						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px] transition-transform duration-300 ease-in-out hover:scale-110" alt="" src="/wp-content/themes/business-setup/web/public/link--instagram.svg"></a>

						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px] transition-transform duration-300 ease-in-out hover:scale-110" alt="" src="/wp-content/themes/business-setup/web/public/link--pinterest.svg"></a>
					</div>
				</div>
				<div class="h-[375px] transition-transform duration-300 ease-in-out hover:scale-105 hover:bg-opacity-75 overflow-hidden flex flex-col items-start justify-end py-[25px] pl-[25px] pr-5 box-border gap-[5px] bg-[url('/wp-content/themes/business-setup/web/public/member-info1@3x.png')] bg-cover bg-no-repeat bg-[top]">
					<h3 class="m-0 self-stretch relative text-5xl tracking-[-0.01em] leading-[30px] font-bold font-inherit mq450:text-lgi mq450:leading-[24px]">
						Elena
					</h3>
					<div class="relative leading-[22px] font-body-b3-merriweather-14">
					...
					<div class="overflow-hidden flex flex-row items-center justify-start gap-2.5">
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px]" alt="" src="/wp-content/themes/business-setup/web/public/link--facebook.svg"></a>

						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px]" alt="" src="/wp-content/themes/business-setup/web/public/link--twitter.svg"></a>

						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px]" alt="" src="/wp-content/themes/business-setup/web/public/link--instagram.svg"></a>

						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px]" alt="" src="/wp-content/themes/business-setup/web/public/link--pinterest.svg"></a>
					</div>
				</div>
				<div class="h-[375px] transition-transform duration-300 ease-in-out hover:scale-105 hover:bg-opacity-75 overflow-hidden flex flex-col items-start justify-end py-[25px] pl-[25px] pr-5 box-border gap-[5px] bg-[url('/wp-content/themes/business-setup/web/public/member-info2@3x.png')] bg-cover bg-no-repeat bg-[top]">
					<h3 class="m-0 self-stretch relative text-5xl tracking-[-0.01em] leading-[30px] font-bold font-inherit mq450:text-lgi mq450:leading-[24px]">
						Samuel
					</h3>
					<div class="relative leading-[22px] font-body-b3-merriweather-14">
				...
				<div class="overflow-hidden transition-transform duration-300 ease-in-out hover:scale-105 hover:bg-opacity-75 flex flex-col items-start justify-end pt-[200px] pb-[25px] pl-[25px] pr-5 gap-[5px] bg-[url('/wp-content/themes/business-setup/web/public/member-info3@3x.png')] bg-cover bg-no-repeat bg-[top] mq450:pt-[130px] mq450:pb-5 mq450:box-border">
					<h3 class="m-0 self-stretch relative text-5xl tracking-[-0.01em] leading-[30px] font-bold font-inherit mq450:text-lgi mq450:leading-[24px]">
						Jaiden
					</h3>
					<div class="relative leading-[22px] font-body-b3-merriweather-14">
			...
			<div class="w-[1170px] grid flex-row items-start justify-start gap-[30px] max-w-full grid-cols-[repeat(4,_minmax(202px,_1fr))] z-[1] text-left text-smi text-general-white font-button-dm-sans-16 lg:justify-center lg:grid-cols-[repeat(2,_minmax(202px,_351px))] mq450:grid-cols-[minmax(202px,_1fr)]">
				...
				<div class="h-[375px] overflow-hidden overflow-hidden flex flex-col items-start justify-end py-[25px] pl-[25px] pr-5 box-border gap-[5px] bg-[url('/wp-content/themes/business-setup/web/about/public/member-profiles1@3x.png')] bg-cover bg-no-repeat bg-[top] transition-transform duration-300 ease-in-out hover:scale-105 hover:bg-opacity-75">
					<h3 class="m-0 self-stretch relative text-5xl tracking-[-0.01em] leading-[30px] font-bold font-inherit mq450:text-lgi mq450:leading-[24px]">
						Roxanna
					</h3>
					<div class="relative leading-[22px] font-body-b3-merriweather-14">
					...
					<div class="overflow-hidden flex flex-row items-center justify-start gap-2.5">
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px] transition-transform duration-300 ease-in-out hover:scale-110" loading="lazy" alt="Facebook"
							 src="/wp-content/themes/business-setup/web/about/public/link--facebook.svg"></a>
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px] transition-transform duration-300 ease-in-out hover:scale-110" loading="lazy" alt="Twitter"
							 src="/wp-content/themes/business-setup/web/about/public/link--twitter.svg"></a>
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px] transition-transform duration-300 ease-in-out hover:scale-110" alt="Instagram" src="/wp-content/themes/business-setup/web/about/public/link--instagram.svg"></a>
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px] transition-transform duration-300 ease-in-out hover:scale-110" alt="Pinterest" src="/wp-content/themes/business-setup/web/about/public/link--pinterest.svg"></a>
					</div>
				</div>

				<!-- Team Member 2: Boris -->
				<div class="h-[375px] transition-transform duration-300 ease-in-out hover:scale-105 hover:bg-opacity-75 overflow-hidden flex flex-col items-start justify-end py-[25px] pl-[25px] pr-5 box-border gap-[5px] bg-[url('/wp-content/themes/business-setup/web/about/public/member-profiles2@3x.png')] bg-cover bg-no-repeat bg-[top]">
					<h3 class="m-0 self-stretch relative text-5xl tracking-[-0.01em] leading-[30px] font-bold font-inherit mq450:text-lgi mq450:leading-[24px]">
						Boris
					</h3>
					<div class="relative leading-[22px] font-body-b3-merriweather-14">
					...
					<div class="overflow-hidden flex flex-row items-center justify-start gap-2.5">
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px]" alt="Facebook" src="/wp-content/themes/business-setup/web/about/public/link--facebook.svg"></a>
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px]" alt="Twitter" src="/wp-content/themes/business-setup/web/about/public/link--twitter.svg"></a>
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px]" alt="Instagram" src="/wp-content/themes/business-setup/web/about/public/link--instagram.svg"></a>
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px]" alt="Pinterest" src="/wp-content/themes/business-setup/web/about/public/link--pinterest.svg"></a>
					</div>
				</div>

				<!-- Team Member 3: Camilla -->
				<div class="h-[375px] transition-transform duration-300 ease-in-out hover:scale-105 hover:bg-opacity-75 overflow-hidden flex flex-col items-start justify-end py-[25px] pl-[25px] pr-5 box-border gap-[5px] bg-[url('/wp-content/themes/business-setup/web/about/public/member-profiles3@3x.png')] bg-cover bg-no-repeat bg-[top]">
					<h3 class="m-0 self-stretch relative text-5xl tracking-[-0.01em] leading-[30px] font-bold font-inherit mq450:text-lgi mq450:leading-[24px]">
						Camilla
					</h3>
					<div class="relative leading-[22px] font-body-b3-merriweather-14">
				...
				<div class="h-[375px] overflow-hidden flex flex-col items-start justify-end py-[25px] pl-[25px] pr-5 box-border gap-[5px] bg-[url('/wp-content/themes/business-setup/web/about/public/member-profiles4@3x.png')] bg-cover bg-no-repeat bg-[top] transition-transform duration-300 ease-in-out hover:scale-105 hover:bg-opacity-75">
					<h3 class="m-0 self-stretch relative text-5xl tracking-[-0.01em] leading-[30px] font-bold font-inherit mq450:text-lgi mq450:leading-[24px]">
						Valentine
					</h3>
					<div class="relative leading-[22px] font-body-b3-merriweather-14">
												...
												<div class="self-stretch flex flex-row items-start justify-end py-0 pl-[49px] pr-[41px] box-border max-w-full lg:pl-6 lg:box-border">
													<div class="w-[980px] flex flex-row items-start justify-start gap-[42px] max-w-full mq950:gap-[21px] mq1425:flex-wrap">
														<img class="w-[330px] relative max-h-full overflow-hidden shrink-0 min-h-[198px] max-w-full z-[4] mq1425:flex-1" loading="lazy" alt=""
															 src="/wp-content/themes/business-setup/web/about/public/girl.png">
		...
		<div class="w-[124px] hidden flex-row items-end justify-start gap-[1px]">
			...
			<div class="h-[24px] w-[24px] relative">
				<img
						...
						alt=""
						src="/wp-content/themes/business-setup/web/about/public/iconsiconly-blacklightarrow-chevronright.svg"
				/>
