		...
		<section class="self-stretch flex flex-row items-start justify-center pt-0  pb-[180px] box-border max-w-full text-left text-base text-general-1-primary font-subtitles-16 lg:pb-[117px] lg:box-border mq850:pb-[76px] mq850:box-border">
			<div class="w-[1170px] flex flex-col items-start justify-start gap-[60px] max-w-full lg:gap-[30px] lg:mx-[0px] lg:ml-[0px] px-[20px] mq650:px-[0px]">
				...
				<div class="self-stretch flex flex-row items-start justify-center flex-wrap content-start gap-10 max-w-full text-general-9-secondary-variant font-body-b3-merriweather-14 mq850:gap-5 mq650:px-[20px]">
					...
					<img class="h-[286px] flex-1 relative max-w-full overflow-hidden object-cover min-w-[367px] mq450:min-w-full" loading="lazy" alt="" src="/wp-content/themes/vision-prime/web/public/company-registration-in-dubai--mainland-vs-free-zone-vs-offshore-11@2x.png">
				</div>
				...
				<div class="flex flex-row w-full max-w-[1170px] py-[54px] px-[54px] bg-general-1-primary relative z-10 mr-[-2px] mq950:flex-col mq650:flex-col mq650:px-[20px]">
					<div class=" flex flex-col items-start justify-start gap-5  mq1500:flex-1 ">
						...
						<h3 class="m-0 self-stretch relative text-5xl tracking-[-0.01em] leading-[30px] font-bold font-inherit mq450:text-lgi mq450:leading-[24px]">
							If you have a potential project or think we’d be the&nbsp;ideal partner to bring it to life, please get in touch at&nbsp;hello@business-setup-in-dubai-uae.com.
						</h3>
					</div>
